<p align="center">
  <a href="https://github.com/bellodox/SpeXcode"><img src="https://raster.shields.io/badge/VS_Code_Marketplace-007ACC?style=flat&logo=visualstudiocode&logoColor=white" alt="VS Code Marketplace"></a>
  <a href="https://github.com/bellodox/SpeXcode"><img src="https://raster.shields.io/badge/SpeXcode-000000?style=flat&logo=x&logoColor=white" alt="X (Twitter)"></a>
  <a href="https://github.com/bellodox/SpeXcode"><img src="https://raster.shields.io/badge/Blog-555?style=flat&logo=substack&logoColor=white" alt="Substack Blog"></a>
  <a href="https://github.com/bellodox/SpeXcode/discussions"><img src="https://raster.shields.io/badge/Join%20Discord-5865F2?style=flat&logo=discord&logoColor=white" alt="Discord"></a>
  <a href="https://github.com/bellodox/SpeXcode/discussions"><img src="https://raster.shields.io/badge/Join%20r%2FSpeXcode-D84315?style=flat&logo=reddit&logoColor=white" alt="Reddit"></a>
</p>

# 🚀 SpeXcode
## VS Code extension for Open-Source Harness for Agentic Engineering
...
- [VS Code Marketplace](https://github.com/bellodox/SpeXcode) (download)
- [Official SpeXcode repository](https://github.com/bellodox/SpeXcode) (learn more)

## Key Features

- **Code Generation:** SpeXcode can generate code using natural language.
- **Inline Autocomplete:** Get intelligent code completions as you type, powered by AI.
- **Task Automation:** SpeXcode can automate repetitive coding tasks to save time..
- **Automated Refactoring:** SpeXcode can refactor and improve existing code efficiently.
- **MCP Server Marketplace**: SpeXcode can easily find, and use MCP servers to extend the agent capabilities.
- **Multi Mode**: Plan with Architect, Code with Coder, and Debug with Debugger, and make your own custom modes.

## Get Started

1. Install the SpeXcode extension from the [VS Code Marketplace](https://github.com/bellodox/SpeXcode).
...
3. Start coding with AI that adapts to your workflow. Watch our quick-start guide to see SpeXcode in action:
...
Contributions are welcome, and they are greatly appreciated! Get started by reading our [Contributing Guide](CONTRIBUTING.md). Or join our [Discord](https://github.com/bellodox/SpeXcode/discussions) to chat with the team and community.

Thanks to all the contributors who help make SpeXcode better!
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <a href="https://github.com/bellodox/SpeXcode/graphs/contributors">
        <b>more ...</b>
      </a>
    </td>
  </tr>
